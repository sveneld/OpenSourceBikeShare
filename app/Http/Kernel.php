...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \BikeShare\Http\Middleware\TrimStrings::class,
        \Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull::class,
        \BikeShare\Http\Middleware\TrustProxies::class,
    ];
    ...
    protected $routeMiddleware = [
        ...
        'guest'       => \BikeShare\Http\Middleware\RedirectIfAuthenticated::class,
