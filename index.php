...
<script type="text/javascript" src="js/functions.js?verzion=2020-05-28-001"></script>
...
<link rel="stylesheet" type="text/css" href="css/map.css?verzion=2020-05-28-001" />
<script>
...
if ($cities && isloggedin()) {
	$usercity = getusercity($_COOKIE['loguserid']);
}
...
if (isloggedin()) {
    ...
    echo '<img src="pics/wbsLogo.png" alt="White bikes - Biele bicykle" style="margin: auto; display: block; margin-top: 1em;" >';
}
...
<div class="row text-center" style="margin-top: 0.5em;">
   ...
   <ul class="list-inline">
      <li><a href="<?php echo $systemrules; ?>" target="_blank"><span class="glyphicon glyphicon-question-sign"></span>Informácie a nápoveda</a></li>
<?php
...
if (isloggedin()) {
	...
	if ($cities) {
		echo '<li><span id="usercity" class="glyphicon glyphicon-map-marker" title="', _('My City'), '"></span></li>','<li><select class="form-control input-sm" id="citychange">';
...
?>
      ...
      <div class="row"><div class="col-lg-12">
            <label for="number" class="control-label"><?php if (issmssystemenabled() == true) {
    echo _('Phone number:');
} else {
    echo _('User number:');
}
